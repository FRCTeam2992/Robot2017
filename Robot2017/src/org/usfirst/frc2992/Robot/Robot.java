...
public class Robot extends IterativeRobot {
    ...
    public static RobotState state = RobotState.Test;
    ...
    public void robotInit() {
    	//CameraServer.getInstance().startAutomaticCapture().setResolution(cameraRes[0], cameraRes[1]);
    	
    	camerafeed = new CameraFeeds(cameraRes, 30);
    	camerafeed.init();
    RobotMap.init();
	...
	*/
    ...
    public void setAutoMode () {
    	...
    	*/
    	...
    	switch (automode) {
    		case 0:	//autonomousCommand = new AutoMidGear();
    				autonomousCommand = new DriveForward(180,5,true,0);
    				autoName = "Stand Still";
    				break;
    		case 1: autonomousCommand = new AutoLeftGearRED();
    				autoName = "Move Forward";
    				break;
    		case 2: autonomousCommand = new AutoLeftGearBLUE();
					autoName = "Move over BD";
					break;
    		case 3: autonomousCommand = new AutoRightGearRED();
					autoName = "Move through Low Bar";
					break;
    		case 4: autonomousCommand = new AutoRightGearBLUE();
