...
public class RobotMap {
    ...
    if(state == RobotState.Test){
        ...
        driveTrainLeftDriveEncoder.setDistancePerPulse(Constants.encoderDistPerPulse);
        ...
        driveTrainRightDriveEncoder.setDistancePerPulse(Constants.encoderDistPerPulse);
