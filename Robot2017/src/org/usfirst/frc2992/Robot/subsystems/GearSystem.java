...
public class GearSystem extends Subsystem {
    ...
    private final double leftServoIn = Constants.leftServoIn;
    private final double rightServoIn = Constants.rightServoIn;
    private final double leftServoOut = Constants.leftServoOut;
    private final double rightServoOut = Constants.rightServoOut;
    ...
    public void gear1to2(){// gear pos 2
    	...
    	//jumpRampInOut.set(false);
    	//deckUpDown.set(true);
    	leftGearHold.setAngle(leftServoIn);
